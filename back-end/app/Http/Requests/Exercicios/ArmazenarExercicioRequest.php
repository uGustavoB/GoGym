...
class ArmazenarExercicioRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo' => 'required|string|in:superior,inferior,core,cardio,full_body',
            'grupo_muscular' => 'required|string|in:peitoral,costas,ombros,biceps,triceps,quadriceps,posterior_coxa,gluteos,panturrilhas,abdomen,outro',
