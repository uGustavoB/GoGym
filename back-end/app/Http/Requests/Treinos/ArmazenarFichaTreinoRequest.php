...
class ArmazenarFichaTreinoRequest extends FormRequest
{
    ...
    {
        $usuario   = $this->user();
        $baseRules = $this->regrasFichaBase() + $this->regrasSemanasRotinas();
        ...
        // Aluno: sem aluno_id no request (será auto-assign no Service)
        return $baseRules;
    }
    ...
    private function regrasSemanasRotinas(): array
    {
        return [
