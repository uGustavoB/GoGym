...
// ── Zod Schema para Edição ──

const exercicioEditSchema = z.object({
...
const rotinaEditSchema = z.object({
  id: z.number().optional(),
  letra_nome: z.string().min(1, "Ex: A, B, C"),
  exercicios: z.array(exercicioEditSchema).min(1, "Adicione ao menos 1 exercício"),
})

const semanaEditSchema = z.object({
  id: z.number().optional(),
...
const fichaEditSchema = z.object({
  ...
  semanas: z.array(semanaEditSchema).min(1, "Adicione ao menos 1 semana"),
  rotinas: z.array(rotinaEditSchema).min(1, "Adicione ao menos 1 rotina"),
})

export type FichaEditFormValues = z.infer<typeof fichaEditSchema>
...
export default function EditarFichaPage() {
  ...
  } = useForm<FichaEditFormValues>({
    resolver: zodResolver(fichaEditSchema),
    defaultValues: {
      aluno_id: 0,
      nome: "",
      objetivo: "",
  ...
  // Modal para tentativa de saida sem salvar
  ...
  // Carrega alunos, exercícios e dados da ficha ao montar
  useEffect(() => {
    if (!id || isNaN(id)) {
      router.push("/dashboard/treinos")
      return
    ...
    async function fetchData() {
      try {
        ...
        reset({
          ...
          data_inicio: ficha.data_inicio.split("T")[0],
          data_vencimento: ficha.data_vencimento ? ficha.data_vencimento.split("T")[0] : "",
          semanas: ficha.semanas.map((s) => ({
            id: s.id,
            ...
            intensidade_carga: s.intensidade_carga || "",
          })),
          rotinas: ficha.rotinas.map((r) => ({
            id: r.id,
            ...
            exercicios: r.exercicios.map((e) => ({
              ...
              tecnica_avancada: e.tecnica_avancada || "",
  ...
  const onSubmit = async (data: FichaEditFormValues) => {
    setSubmitting(true)
    try {
      ...
      await atualizarFicha(id, payload)
      setSubmitSuccess(true)
      toast.success("Ficha de treino atualizada com sucesso!")
      
      // Como react-hook-form "dirty" trackeia alteracoes a partir do defaultValues,
      // reseta para nao ser mais dirty
      reset(data)
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Apenas Personal Trainers podem editar fichas de treino.
        </p>
      </div>
    )
  }
        ...
        <div className="flex items-center gap-4">
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Todas as informações preenchidas serão perdidas. Tem certeza
                  que deseja sair?
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Altere as informações, periodizações, rotinas e exercícios da
              ficha.
            </p>
          </div>
        </div>
                ...
                <Card className="shadow-sm">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-col space-y-1.5">
                      ...
                      <Popover open={openAluno} onOpenChange={setOpenAluno}>
                        <PopoverTrigger asChild>
                          ...
                          >
                            {watch("aluno_id")
                              ? alunos.find((a) => a.id === watch("aluno_id"))
                                  ?.nome
                              : "Selecione um aluno..."}
                    ...
                    <div className="space-y-1.5">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Visível apenas para você como personal.
                      </p>
                    </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <Button
                                ...
                                onClick={() => {
                                  const currentWeek = getValues(
                                    `semanas.${index}`
                                  )
                                  appendSemana({
                                    numero_semana:
                                      currentWeek.numero_semana + 1,
                                    descricao_fase: currentWeek.descricao_fase,
                                    repeticoes_alvo:
                                      currentWeek.repeticoes_alvo,
                                    rir_alvo: currentWeek.rir_alvo,
                                    intensidade_carga:
                                      currentWeek.intensidade_carga,
                                  })
                                }}
                              >
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                <TooltipProvider>
                                  <Tooltip>
                                    ...
                                    >
                                      <p>
                                        Quantas reps o aluno sente que ainda
                                        faria ao final da série. 0 = falha
                                        total, 1-2 = pesado, 3-4 = moderado.
                                      </p>
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                <TooltipProvider>
                                  <Tooltip>
                                    ...
                                    >
                                      <p>
                                        Referência baseada na força máxima.
                                        Hipertrofia/força costuma ficar entre
                                        70-85%.
                                      </p>
                                    </TooltipContent>
                                  </Tooltip>
                      ...
                      <Card key={field.id}>
                        ...
                        <CardContent>
                          <ExercicioRotinaFields
                            rotinaIndex={rIndex}
                            control={
                              control as unknown as Control<FichaFormValues>
                            }
                            register={
                          ...
                          {errors.rotinas?.[rIndex]?.exercicios &&
                            !Array.isArray(
                              ...
                              <p className="mt-2 text-xs text-destructive">
                                {
                                  (
                                    errors.rotinas[rIndex].exercicios as {
                                      message?: string
                                    }
                                  )?.message
                                }
